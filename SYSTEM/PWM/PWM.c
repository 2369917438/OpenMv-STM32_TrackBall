...
void TIM1_PWM_Init(void)
{
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化GPIOA_Pin_8|11
	...
	TIM_OC1PreloadConfig(TIM1, TIM_OCPreload_Enable);						 //使能通道1输出
	TIM_OC4PreloadConfig(TIM1, TIM_OCPreload_Enable);						 //使能通道2输出
